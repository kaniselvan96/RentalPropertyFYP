                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 mx-auto">
                                    ...
                                    <hr class="my-4" />
                                    <div class="row">
                                        <div class="col-md-4 my-2" v-for="(product, index) in checkedfacilities" :key="index">
                                            <div class="col ml--2">
...
<script>
    ...
    export default {
        props: ["houseview", "savedfacilities","housephotolink"],
        components: {
            VueImageSlider,
        },
        data() {
            return {
                ...
                imageArray: this.housephotolink
            };
        },
        computed: {},
        methods: {},
